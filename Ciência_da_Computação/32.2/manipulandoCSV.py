...
with open("balneabilidade.csv") as file:
    ...
    # O leitor define como dialeto padrão excel,
    # que significa dizer que o delimitador de campos será a " , "
    # e o caractere de citação será aspas duplas ( " )
...
# Podemos fazer uma análise agrupando a balneabilidade por campanha
# e depois salvamos o resultado também no formato csv:
...
# Existe ainda o leitor e escritor baseado em dicionários.
# A vantagem é não precisar manipular os índices para acessar as colunas.
# Mas tem como desvantagem o espaço ocupado em memória, maior que o comum:
